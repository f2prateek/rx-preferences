...
public class PreferenceTest {
    ...
    public void setUp() {
        ...
        preferences = context.getSharedPreferences(getDefaultSharedPreferencesName(context), Context.MODE_PRIVATE);
    ...
    @Test
    public void defaultDefaultValue() {
    ...
    @Test
    public void getWithNoValueReturnsDefaultValue() {
    ...
    @Test
    public void getWithStoredValue() {
    ...
    @Test
    public void converterMayNotReturnNull() {
    ...
    @Test
    public void stringSetDefaultIsUnmodifiable() {
    ...
    @Test
    public void asConsumer() throws Throwable {
        Preference<String> preference = rxPreferences.getString("foo");
    ...
    @Test
    public void legacyNullSet() {
        nullValue("set");
        List<String> strings = asList("able", "baker", "charlie");
        Set<String> defaultSet = new HashSet<>(strings);
        Set<String> expectedSet = new HashSet<>(strings);
